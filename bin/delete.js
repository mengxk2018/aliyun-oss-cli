...
exports.deletePrefix = void 0;
/** 处理请求失败的情况，防止promise.all中断，并返回失败原因和失败文件名 */
function handleDel(client, name, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, client["delete"](name)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
*/
function deletePrefix(client, prefix, maxKeys) {
    if (maxKeys === void 0) { maxKeys = 1000; }
    return __awaiter(this, void 0, void 0, function () {
        var list, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.list({ prefix: prefix, 'max-keys': maxKeys }, {})];
                case 1:
                    list = _a.sent();
